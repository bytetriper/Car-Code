#include <Arduino.h>
#line 1 "d:\\Arduino\\project\\Vehicle\\main\\src\\src.ino"
#include "QGPMaker_MotorShield.h"
#include "QGPMaker_IICSensorbar.h"
#include "QGPMaker_Encoder.h"
#line 4 "d:\\Arduino\\project\\Vehicle\\main\\src\\src.ino"
void abort(const char * words);
#line 10 "d:\\Arduino\\project\\Vehicle\\main\\src\\src.ino"
void log(const char * words);
#line 379 "d:\\Arduino\\project\\Vehicle\\main\\src\\src.ino"
void setup();
#line 398 "d:\\Arduino\\project\\Vehicle\\main\\src\\src.ino"
void loop();
#line 4 "d:\\Arduino\\project\\Vehicle\\main\\src\\src.ino"
void abort(const char * words)
{
...
class vehicle
{
    ...
    void forward(wheel_position id)
    {
        ...
        {
            case LF:
                wheels[id]->run(FORWARD);
                break;
            case LR:
                wheels[id]->run(FORWARD);
                break;
            case RF:
                wheels[id]->run(BACKWARD);
                break;
            case RR:
                wheels[id]->run(BACKWARD);
                break;
    ...
    void adjust_line_Speed(bool op=true)
    {
        ...
        if(dir==offset::Toleft)
            log("Too Right");
        if(dir==offset::Mean||dir==offset::Left||dir==offset::Right||dir==outline)
        {
            run(Forward);
            Speed(LR,40);
            Speed(LF,40);
...
void setup() {
  ...
  // put your setup code here, to run once:
    ...
    car.angle(vehicle::Servors::One,0);
    car.angle(vehicle::Servors::Two,0);
    car.angle(vehicle::Servors::Three,50);
    car.angle(vehicle::Servors::Four,0);
    car.Speed(vehicle::wheel_position::LF,40);
    car.Speed(vehicle::wheel_position::LR,40);
    car.Speed(vehicle::wheel_position::RF,56);
    car.Speed(vehicle::wheel_position::RR,56);
    //car.setrpm(50)
